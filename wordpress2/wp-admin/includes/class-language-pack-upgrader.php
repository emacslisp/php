...
class Language_Pack_Upgrader extends WP_Upgrader {
	 ...
	 */
	public static function async_upgrade( $upgrader = false ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
		// Avoid recursion.
	 ...
	 */
	public function upgrade( $update = false, $args = array() ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
		if ( $update ) {
			$update = array( $update );
		}
	 ...
	 */
	public function bulk_upgrade( $language_updates = array(), $args = array() ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
	 ...
	 */
	public function check_package( $source, $remote_source ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
		global $wp_filesystem;
	 ...
	 */
	public function get_name_for_update( $update ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
		switch ( $update->type ) {
			case 'core':
