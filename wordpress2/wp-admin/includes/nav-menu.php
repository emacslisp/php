 ...
 */
function _wp_ajax_menu_quick_search( $request = array() ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
	$args = array();
 ...
 * @since 3.0.0
 **/
function wp_nav_menu_setup() {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
	// Register meta boxes
 ...
 **/
function wp_initial_nav_menu_meta_boxes() {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
 ...
 * @since 3.0.0
 */
function wp_nav_menu_post_type_meta_boxes() {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
 ...
 * @since 3.0.0
 */
function wp_nav_menu_taxonomy_meta_boxes() {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
 ...
 */
function wp_nav_menu_disabled_check( $nav_menu_selected_id ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
 ...
 */
function wp_nav_menu_item_link_meta_box() {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
 ...
 * }
 */
function wp_nav_menu_item_post_type_meta_box( $object, $box ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
	global $_nav_menu_placeholder, $nav_menu_selected_id;
 ...
 * }
 */
function wp_nav_menu_item_taxonomy_meta_box( $object, $box ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
 ...
 */
function wp_save_nav_menu_items( $menu_id = 0, $menu_data = array() ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
	$menu_id = (int) $menu_id;
	$items_saved = array();
 ...
 */
function _wp_nav_menu_meta_box_object( $object = null ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
 ...
 */
function wp_get_nav_menu_to_edit( $menu_id = 0 ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
 ...
 */
function wp_nav_menu_manage_columns() {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
	return array(
 ...
 */
function _wp_delete_orphaned_draft_menu_items() {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
	global $wpdb;
 ...
 */
function wp_nav_menu_update_menu_items ( $nav_menu_selected_id, $nav_menu_selected_title ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
 ...
 * @access private
 */
function _wp_expand_nav_menu_post_data() {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
