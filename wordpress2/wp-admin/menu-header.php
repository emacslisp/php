 ...
 */
function _wp_menu_output( $menu, $submenu, $submenu_as_parent = true ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
