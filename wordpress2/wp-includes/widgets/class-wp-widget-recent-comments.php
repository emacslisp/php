...
class WP_Widget_Recent_Comments extends WP_Widget {
	 ...
	 * @access public
	 */
	public function recent_comments_style() {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
		/**
	 ...
	 */
	public function flush_widget_cache() {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
