...
class Requests_Response {
	 ...
	 */
	public function is_redirect() {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
	 ...
	 */
	public function throw_for_status($allow_redirects = true) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
		if ($this->is_redirect()) {
			if (!$allow_redirects) {
