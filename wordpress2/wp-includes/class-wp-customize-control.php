...
class WP_Customize_Control {
	 ...
	 */
	final public function value( $setting_key = 'default' ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
	 ...
	 */
	public function get_link( $setting_key = 'default' ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
		if ( ! isset( $this->settings[ $setting_key ] ) )
			return '';
	 ...
	 * @param string $setting_key
	 */
	public function link( $setting_key = 'default' ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
	 ...
	 * @access public
	 */
	public function input_attrs() {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
	 ...
	 * @since 4.1.0
	 */
	final public function print_template() {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
		?>
