 ...
 */
function add_rewrite_rule( $regex, $query, $after = 'bottom' ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
	global $wp_rewrite;
 ...
 */
function add_rewrite_tag( $tag, $regex, $query = '' ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
 ...
 */
function remove_rewrite_tag( $tag ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
	global $wp_rewrite;
 ...
 */
function add_permastruct( $name, $struct, $args = array() ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
	global $wp_rewrite;
 ...
 * @param string $name Name for permalink structure.
 */
function remove_permastruct( $name ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
	global $wp_rewrite;
 ...
 */
function add_feed( $feedname, $function ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
	global $wp_rewrite;
 ...
 */
function flush_rewrite_rules( $hard = true ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
	global $wp_rewrite;
 ...
 */
function add_rewrite_endpoint( $name, $places, $query_var = true ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
	global $wp_rewrite;
 ...
 * @return string
 */
function _wp_filter_taxonomy_base( $base ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
	if ( !empty( $base ) ) {
 ...
 */
function wp_resolve_numeric_slug_conflicts( $query_vars = array() ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
 ...
 */
function url_to_postid( $url ) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
	global $wp_rewrite;
