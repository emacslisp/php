...
//http://localhost:8082/wordpress_reading/wp-admin/install.php?language=en_US
...
<p id="logo"><a href="<?php echo  __( 'https://wordpress.org/' ) ?>" tabindex="-1"><?php _e( 'WordPress' ); ?></a></p>
