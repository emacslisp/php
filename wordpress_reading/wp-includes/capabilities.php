 ...
 *        	User ID.
 * @param int $object_id
 *        	Optional. ID of the specific object to check against if `$cap` is a "meta" cap.
 ...
 *        	Capability name.
 * @param int $object_id
 *        	Optional. ID of the specific object to check against if `$capability` is a "meta" cap.
 *        	"Meta" capabilities, e.g. 'edit_post', 'edit_user', etc., are capabilities used
 *        	by map_meta_cap() to map to other "primitive" capabilities, e.g. 'edit_posts',
...
function current_user_can_for_blog($blog_id, $capability) {
	...
	$can = call_user_func_array ( array (
			$current_user,
			'has_cap' 
	), $args );
 ...
 *       
 * @param int $user_id
 *        	(Optional) The ID of a user. Defaults to the current user.
