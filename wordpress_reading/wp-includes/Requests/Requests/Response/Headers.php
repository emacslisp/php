...
class Requests_Response_Headers extends Requests_Utility_CaseInsensitiveDictionary {
	 ...
	 */
	public function getValues($key) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
		$key = strtolower($key);
		if (!isset($this->data[$key])) {
			return null;
		}
	 ...
	 */
	public function flatten($value) {file_put_contents('/Users/ewu/output.log',print_r((new Exception)->getTraceAsString(),true). PHP_EOL . PHP_EOL,FILE_APPEND);
		if (is_array($value)) {
			$value = implode(',', $value);
		}
